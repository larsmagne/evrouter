...
action_shell.h -- Shell command action interface
...
$Id: action_shell.h 6 2004-09-07 22:57:39Z alexios $
...
#ifndef ACTION_SHELL_H
#define ACTION_SHELL_H
...
int parse_shell (int line_num, event_rule_t * r, char * s);

void handle_shell (struct input_event * ev, event_rule_t * r, unsigned int mods);


#endif /* ACTION_SHELL_H */
