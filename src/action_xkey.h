...
action_xkey.h -- Xkey command action interface
...
$Id: action_xkey.h 6 2004-09-07 22:57:39Z alexios $
...
#ifndef ACTION_XKEY_H
#define ACTION_XKEY_H
...
int parse_xkey (int line_num, event_rule_t * r, char * s);

void handle_xkey (struct input_event * ev, event_rule_t * r, unsigned int mods);
